...
[![Language](https://img.shields.io/badge/LANGUAGE-中%20|%20EN-4E737E?style=for-the-badge&labelColor=334A51)](./README.md)

#### 关于：
这是一个带有雨后泥土湿润气息的着色器，具有像素效果和噪点。  
这是我编写的第五个着色器包，它基于我的[Lantern](https://modrinth.com/shader/lantern-shader)着色器修改而来，希望你能喜欢(^-^)  

#### 性能：
并不需要多高配置的电脑，核显就足以流畅运行  
视距设置推荐8个区块体验最好，可以更少，但不宜过多，一般8～11个就好。
...
- **答**：将本着色器作为整合包的一部分进行分发，而不修改其源代码，不视作创建派生作品。整合包的其他组件不受 GPLv3 约束。
